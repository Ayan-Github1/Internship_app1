           ...
           child: Column(
             children: <Widget>[
               Padding(
                  ...
                  Text('test1234',style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold),),
                      ...
                      child: Column(
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text("Personal details",style:TextStyle(fontSize: 10.0,fontWeight: FontWeight.bold)),
                          ),
                          Row(
                              children:<Widget>[
                                Padding(
                                ...
                                Row(
                                  children: <Widget>[
                                    Padding(
                                      padding: const EdgeInsets.only(top:10,bottom:10.0,right: 5.0,left: 32.0),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(right: 8.0,left: 55.0),
                                  child: Row(
                                    children: [
                          ...
                          Row(
                            children: <Widget>[
                              Text("Mobile Number",style: TextStyle(fontSize: 10.0),),
                              Padding(
                                padding: const EdgeInsets.only(top:10,bottom:10.0,right: 8.0,left: 48.0),
                                child: Row(
                                  children: [
                          ...
                          Row(
                            children: <Widget>[
                              Text("Country",style: TextStyle(fontSize: 10.0),),
                              Padding(
                                padding: const EdgeInsets.only(right: 8.0,left: 82.0),
                                child: Row(
                                  children: [
                    ...
                    child: Column(
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text("Medical insurance information",style:TextStyle(fontSize: 10.0,fontWeight: FontWeight.bold)),
                        ),
                        Row(
                          children:<Widget>[
                            Padding(
                            ...
                            Row(
                              children: <Widget>[
                                Padding(
                                  padding: const EdgeInsets.only(top:10,bottom:10.0,right: 8.0),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text("Health Insurance",style: TextStyle(fontSize: 10.0),),
                            Padding(
                        ...
                        Row(
                          children: <Widget>[
                            Text("Policy Number",style: TextStyle(fontSize: 10.0),),
                            Padding(
                              padding: const EdgeInsets.only(top:10,bottom:10.0,right: 8.0,left: 50.0),
                              child: Row(
                                children: [
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Padding(
                              padding: const EdgeInsets.only(top:0.0,bottom:15.0,right: 8.0,left: 13.0),
                              child: Row(
                                children: [
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.only(right: 200.0),
                          child: Text("Vehicle Insurance information",style:TextStyle(fontSize: 10.0,fontWeight: FontWeight.bold)),
                        ),
                        Padding(
                     ...
                     child: Column(
                       children: <Widget>[
                         Padding(
                           ...
                           child: Text("Emergency contacts",style: TextStyle(fontSize: 10.0,fontWeight: FontWeight.bold),),
                         ),
                         Padding(
                           padding: const EdgeInsets.only(right: 90.0),
                           child: Text("Add and edit emergency contact list in vehicle settings.",style: TextStyle(fontSize: 10.0),),
                         ),
                          Padding(
                            padding: const EdgeInsets.only(right: 180.0),
                            child: Text("Menu > Settings > Vehicle settings",style: TextStyle(fontSize: 10.0,fontWeight: FontWeight.bold),),
